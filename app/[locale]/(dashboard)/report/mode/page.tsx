    ...
    <main className="flex-1 flex flex-col items-center justify-center p-6 container mx-auto max-w-4xl">
      ...
      <div className="grid md:grid-cols-2 gap-6 w-full mb-8">
        <motion.button
          ...
          className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-[#4A90B8] transition-all text-left group flex flex-col h-full"
        >
          ...
          <h2 className="text-2xl font-bold text-[#1B4F72] mb-3">{t("victim_title")}</h2>
          <p className="text-gray-600 leading-relaxed flex-1">{t("victim_desc")}</p>
        </motion.button>
        ...
        >
          <div className="bg-[#EBF5FB] w-16 h-16 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <Users className="w-8 h-8 text-[#4A90B8]" />
          </div>
          <h2 className="text-2xl font-bold text-[#1B4F72] mb-3">{t("witness_title")}</h2>
          <p className="text-gray-600 leading-relaxed mb-4">{t("witness_desc")}</p>

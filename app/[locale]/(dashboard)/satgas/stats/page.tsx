  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-[#1A5276]/80 text-sm mt-1">Laporan analitik dan tren kekerasan di lingkup kampus.</p>
      </motion.div>

      <div className="bg-white border border-blue-100 rounded-2xl p-12 text-center text-gray-500 shadow-sm">
        <div className="w-16 h-16 bg-[#EBF5FB] text-[#1A5276] rounded-2xl flex items-center justify-center mx-auto mb-4">

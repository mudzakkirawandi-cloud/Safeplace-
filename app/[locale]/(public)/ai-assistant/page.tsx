    ...
    <div className="min-h-screen bg-[#E7E9EB] py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-[#1B4F72] sm:text-4xl">{t("title")}</h1>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="order-1 lg:order-2 space-y-6">
            <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/5">
              <h2 className="mb-4 text-lg font-semibold text-[#1B4F72]">{t("quick_actions_title")}</h2>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-1">
                {quickActions.map((action, index) => (
                  <Link
                    key={index}
                    href={action.href}
                    className="flex items-center gap-3 rounded-xl border border-gray-200 p-3 text-[#242424] transition-colors hover:border-[#1B4F72] hover:bg-[#1B4F72]/5"
                  >
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#E7E9EB] text-[#1B4F72]">
          ...
          <div className="order-2 lg:order-1 lg:col-span-2">
            <div className="flex h-[600px] flex-col overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5">
              <div className="flex items-center gap-3 bg-[#1B4F72] px-6 py-4 text-white">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-white">
                ...
                {isLoading && (
                  <div className="flex items-start gap-3">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#1B4F72] text-white">
                      <Bot className="h-5 w-5" />
                    </div>
                    <div className="bg-[#E7E9EB] text-[#242424] rounded-2xl rounded-tl-none px-5 py-4 shadow-sm">
                      <div className="flex gap-1.5">
                        <motion.div
                          className="h-2.5 w-2.5 rounded-full bg-[#1B4F72]"
                          animate={{ y: [0, -6, 0] }}
              ...
              <div className="border-t border-gray-200 bg-gray-50 p-4">
                <div className="relative">
                  <textarea
                    ...
                    className="w-full resize-none rounded-xl border border-gray-300 bg-white py-3.5 pl-4 pr-14 text-base text-[#242424] focus:border-[#1B4F72] focus:outline-none focus:ring-1 focus:ring-[#1B4F72] shadow-sm"
                    rows={1}
                  ...
                  <button
                    ...
                    className="absolute bottom-2 right-2 flex h-9 w-9 items-center justify-center rounded-lg bg-[#1B4F72] text-white transition-colors hover:bg-[#133A54] disabled:opacity-50"
                  >

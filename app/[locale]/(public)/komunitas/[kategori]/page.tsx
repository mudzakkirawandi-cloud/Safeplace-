...
import { 
  ...
  Users, AlertCircle, Plus, MessageCircle, X, EyeOff, User, ArrowLeft
} from "lucide-react";
...
export default function CategoryPage({ params }: { params: { kategori: string } }) {
  ...
  const validCategories = ["share_story", "recovery", "legal", "qna", "support"];
  ...
  const categories = {
    share_story: { icon: Heart, label: t("cat_share_story"), desc: t("cat_desc_share_story"), color: "text-red-500 bg-red-50", border: "border-red-100" },
    recovery: { icon: Shield, label: t("cat_recovery"), desc: t("cat_desc_recovery"), color: "text-blue-500 bg-blue-50", border: "border-blue-100" },
    legal: { icon: GraduationCap, label: t("cat_legal"), desc: t("cat_desc_legal"), color: "text-purple-500 bg-purple-50", border: "border-purple-100" },
    qna: { icon: MessageCircle, label: t("cat_qna"), desc: t("cat_desc_qna"), color: "text-orange-500 bg-orange-50", border: "border-orange-100" },
    support: { icon: Users, label: t("cat_support"), desc: t("cat_desc_support"), color: "text-green-500 bg-green-50", border: "border-green-100" },
  };
          ...
          <div className={`mb-8 rounded-3xl bg-card p-8 shadow-sm border ${currentCategory.border} relative overflow-hidden`}>
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-start gap-4">
                <div className={`flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl ${currentCategory.color}`}>

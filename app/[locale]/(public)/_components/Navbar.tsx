...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition duration-300 bg-white ${isScrolled ? "shadow-sm py-2" : "py-3"
          }`}
      >
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`text-sm font-medium transition duration-300 hover:text-[#E74C3C] relative group ${isActive ? "text-[#E74C3C]" : "text-primary"
                    }`}
                >
                  {link.label}
                  <span
                    className={`absolute -bottom-1 left-0 h-0.5 bg-[#E74C3C] transition duration-300 ${isActive ? "w-full" : "w-0 group-hover:w-full"
                      }`}
                  ></span>
                </Link>
              );
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            {userSession ? (
              ...
              <>
                ...
                <Link
                  href="/report/start"
                  className="px-5 py-2 text-sm font-medium text-white bg-primary hover:bg-[#154360] shadow-[0_0_15px_rgba(27,79,114,0.3)] hover:shadow-[0_0_20px_rgba(27,79,114,0.5)] rounded-lg transition"
                >
                  {t("start_report")}
                </Link>
              </>
            ...
            {userSession ? (
              ...
              <>
                ...
                <Link
                  href="/report/start"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="w-full text-center px-5 py-3 text-lg font-medium text-white bg-primary shadow-[0_0_15px_rgba(27,79,114,0.3)] rounded-xl transition"
                >
                  {t("start_report")}
                </Link>
              </>
